//
//  RecentExperiencesRepositoryTests.swift
//  AroundEgyptTests
//
...
// MARK: - Tests
final class RecentExperiencesRepositoryTests: XCTestCase {
    
    private var sut: RecentExperiencesRepository!
    ...
    func testFetchRecentExperiences_ReturnsCached_WhenExists() async throws {
        ...
        let repository = RecentExperiencesRepository(service: mockService, experiencesLocal: mockLocal)
    ...
    func testFetchRecentExperiencesRemote_ThrowsOnNetworkError() async {
        ...
        // Act + Assert
        do {
            _ = try await repository.fetchRecentExperiencesRemote()
