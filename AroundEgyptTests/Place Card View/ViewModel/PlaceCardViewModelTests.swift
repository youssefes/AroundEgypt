...
final class PlaceCardViewModelTests: XCTestCase {
    
    private var sut: PlaceCardViewModel!
    ...
    func testLikeExperiences_Failure() async {
        ...
        sut = PlaceCardViewModel(placeCardModel: paceCardModel, likeExperiencesUseCase: mockUseCase)
        // Act + Assert
        sut.likeExperiences()
